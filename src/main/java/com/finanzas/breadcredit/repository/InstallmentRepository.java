...
public interface InstallmentRepository extends JpaRepository<Installment, Long> {
    ...
    @Query("SELECT i FROM Installment i WHERE i.payment IS NULL AND i.purchase.creditaccount.customer.id = :customerId")
    List<Installment> findInstallmentsWithNoPaymentByCustomerId(@Param("customerId") Long customerId);
}